...
* @returns {any}
*/
export function get_geom(screen_width, screen_height, point_count) {
    const ret = wasm.get_geom(screen_width, screen_height, point_count);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('tvs_sketch_bevel_lines_2d_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
