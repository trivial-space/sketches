...
export function get_init_data(a: number): number;
export function get_single_painting(a: number, b: number, c: number): number;
export function get_painting_animation(a: number): number;
