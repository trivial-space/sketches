...
* @returns {any}
*/
export function get_init_data(paintings_count) {
    const ret = wasm.get_init_data(paintings_count);
...
* @returns {any}
*/
export function get_painting_animation(i) {
    const ret = wasm.get_painting_animation(i);
    return takeObject(ret);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('tvs_sketch_tile_fields_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
