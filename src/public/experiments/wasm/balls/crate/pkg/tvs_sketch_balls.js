...
*/
export function get_mvp() {
    const ret = wasm.get_mvp();
    return takeObject(ret);
}
...
* @returns {Float32Array}
*/
export function get_normal_mat() {
    const ret = wasm.get_normal_mat();
    return takeObject(ret);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('tvs_sketch_balls_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
