...
export const pointsSketch = makeSketchEntity(painter).react(
...
export const points = makeDrawingLayerEntity(painter).react(
...
const updateOutBuffer = (l: Layer, out: Layer, size: any, frag: string) =>
	l.update({
		buffered: true,
		...size,
		frag,
