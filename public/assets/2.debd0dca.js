var y=Object.defineProperty;var v=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,z=Object.prototype.propertyIsEnumerable;var c=(o,e,i)=>e in o?y(o,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):o[e]=i,h=(o,e)=>{for(var i in e||(e={}))P.call(e,i)&&c(o,i,e[i]);if(v)for(var i of v(e))z.call(e,i)&&c(o,i,e[i]);return o};var r=(o,e,i)=>(c(o,typeof e!="symbol"?e+"":e,i),i);import"./modulepreload-polyfill.b7f2da20.js";import{g as D,b as S,m as p,r as L}from"./painterState.2081fc22.js";import{c as f,g as d,h as C,e as M}from"./vendor.86045b5f.js";import{p as I}from"./plane.159d540e.js";import{i as T}from"./perspectiveViewport.0dcf679b.js";import"./pointer.1f73fbf8.js";import"./camera.94126e27.js";const N=document.getElementById("canvas"),m=h({},S),t=D(N);class b{constructor(){r(this,"time",0);r(this,"groundColor",[.7,.6,.9,1]);r(this,"groundTransform",f());r(this,"rotationSpeed",2e-4);r(this,"lightRotation",-Math.PI*.8);r(this,"lightPosition",[0,3.5,0]);r(this,"lightColor",[1,1,1,0]);r(this,"lightBackColor",[0,0,.2,0]);r(this,"lightTransforms",[f(),f()]);d(this.groundTransform,this.groundTransform,Math.PI/2),C(this.groundTransform,this.groundTransform,[10,10,10]),this.update(0)}update(e){this.time+=e,this.lightRotation+=this.rotationSpeed*e,this.lightPosition[1]+=Math.sin(this.time/2e3)*.05,M(this.lightTransforms[0],this.lightPosition),d(this.lightTransforms[0],this.lightTransforms[0],this.lightRotation),d(this.lightTransforms[1],this.lightTransforms[0],Math.PI)}}t.listen("entities",m.FRAME,o=>{o.scene.update(o.device.tpf)});t.set("scene",new b);var E=`#version 300 es
...
`;const{state:a,gl:s}=t;T(t,{fovy:Math.PI*.3,position:[11,2,-9],rotationY:2});const V=I(10,10,0,0),u=t.getForm("plane").update(V),x=t.getShade("geo").update({frag:E,vert:j}),w=t.getLayer("tex").update({texture:{}}),g=new Image;g.onload=()=>{w.update({texture:{asset:g,minFilter:"LINEAR_MIPMAP_LINEAR",magFilter:"LINEAR"}})};g.src="tree.jpg";const R=t.getSketch("ground").update({form:u,shade:x,uniforms:{transform:()=>a.scene.groundTransform,color:()=>a.scene.groundColor}}),A=t.getSketch("light").update({form:u,shade:x,uniforms:[{transform:()=>a.scene.lightTransforms[0],color:()=>a.scene.lightColor},{transform:()=>a.scene.lightTransforms[1],color:()=>a.scene.lightBackColor}],drawSettings:{enable:[s.CULL_FACE]}}),l={type:"FLOAT"},n=t.getLayer("scene").update({sketches:[A,R],uniforms:{view:()=>a.viewPort.camera.viewMat,projection:()=>a.viewPort.camera.projectionMat},drawSettings:{enable:[s.DEPTH_TEST],clearBits:p(s,"color","depth")},bufferStructure:[l,l,l,l]}),k=t.getEffect("light").update({frag:F,uniforms:{eyePosition:()=>a.viewPort.camera.position,lightMat:()=>a.scene.lightTransforms[0],view:()=>a.viewPort.camera.viewMat,tex:()=>w.image(),positions:n.image(0),normals:n.image(1),uvs:n.image(2),colors:n.image(3)},drawSettings:{enable:[s.BLEND],clearBits:p(s,"color")}});t.listen("renderer",m.RESIZE,()=>{n.update()});L(o=>{t.get("device").tpf=o,t.emit(m.FRAME),t.painter.compose(n),t.painter.draw({effects:k})},"loop");(!1).accept();
