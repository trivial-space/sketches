var y=Object.defineProperty;var v=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,z=Object.prototype.propertyIsEnumerable;var c=(o,e,i)=>e in o?y(o,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):o[e]=i,h=(o,e)=>{for(var i in e||(e={}))P.call(e,i)&&c(o,i,e[i]);if(v)for(var i of v(e))z.call(e,i)&&c(o,i,e[i]);return o};var a=(o,e,i)=>(c(o,typeof e!="symbol"?e+"":e,i),i);import"./modulepreload-polyfill.b7f2da20.js";import{g as S,b as D,m as u,r as L}from"./painterState.2081fc22.js";import{c as f,g as m,h as C,e as M}from"./vendor.86045b5f.js";import{p as I}from"./plane.159d540e.js";import{i as T}from"./perspectiveViewport.0dcf679b.js";import"./pointer.1f73fbf8.js";import"./camera.94126e27.js";const N=document.getElementById("canvas"),d=h({},D),t=S(N);class b{constructor(){a(this,"time",0);a(this,"groundColor",[.7,.6,.9,1]);a(this,"groundTransform",f());a(this,"rotationSpeed",2e-4);a(this,"lightRotation",-Math.PI*.8);a(this,"lightPosition",[0,3.5,0]);a(this,"lightColor",[1,1,1,0]);a(this,"lightBackColor",[0,0,.2,0]);a(this,"lightTransforms",[f(),f()]);m(this.groundTransform,this.groundTransform,Math.PI/2),C(this.groundTransform,this.groundTransform,[10,10,10]),this.update(0)}update(e){this.time+=e,this.lightRotation+=this.rotationSpeed*e,this.lightPosition[1]+=Math.sin(this.time/2e3)*.05,M(this.lightTransforms[0],this.lightPosition),m(this.lightTransforms[0],this.lightTransforms[0],this.lightRotation),m(this.lightTransforms[1],this.lightTransforms[0],Math.PI)}}t.listen("entities",d.FRAME,o=>{o.scene.update(o.device.tpf)});t.set("scene",new b);var E=`#version 300 es
...
`,V="/assets/tree.50f4656c.jpg";const{state:r,gl:s}=t;T(t,{fovy:Math.PI*.3,position:[11,2,-9],rotationY:2});const R=I(10,10,0,0),p=t.getForm("plane").update(R),x=t.getShade("geo").update({frag:E,vert:j}),w=t.getLayer("tex").update({texture:{}}),g=new Image;g.onload=()=>{w.update({texture:{asset:g,minFilter:"LINEAR_MIPMAP_LINEAR",magFilter:"LINEAR"}})};g.src=V;const A=t.getSketch("ground").update({form:p,shade:x,uniforms:{transform:()=>r.scene.groundTransform,color:()=>r.scene.groundColor}}),k=t.getSketch("light").update({form:p,shade:x,uniforms:[{transform:()=>r.scene.lightTransforms[0],color:()=>r.scene.lightColor},{transform:()=>r.scene.lightTransforms[1],color:()=>r.scene.lightBackColor}],drawSettings:{enable:[s.CULL_FACE]}}),l={type:"FLOAT"},n=t.getLayer("scene").update({sketches:[k,A],uniforms:{view:()=>r.viewPort.camera.viewMat,projection:()=>r.viewPort.camera.projectionMat},drawSettings:{enable:[s.DEPTH_TEST],clearBits:u(s,"color","depth")},bufferStructure:[l,l,l,l]}),_=t.getEffect("light").update({frag:F,uniforms:{eyePosition:()=>r.viewPort.camera.position,lightMat:()=>r.scene.lightTransforms[0],view:()=>r.viewPort.camera.viewMat,tex:()=>w.image(),positions:n.image(0),normals:n.image(1),uvs:n.image(2),colors:n.image(3)},drawSettings:{enable:[s.BLEND],clearBits:u(s,"color")}});t.listen("renderer",d.RESIZE,()=>{n.update()});L(o=>{t.get("device").tpf=o,t.emit(d.FRAME),t.painter.compose(n),t.painter.draw({effects:_})},"loop");
